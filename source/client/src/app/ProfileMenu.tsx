export default function ProfileMenu() {
  return (
    <>
      <div className="absolute z-20 h-auto w-56 top-11 right-0 bg-neutral-900 rounded-md flex flex-col gap-5 p-4">
        <div className="w-full flex justify-between px-3 gap-2">
          ...
          <p className="text-base font-medium w-full pl-3">Profile</p>
        </div>
...
c10,4.6,19.8,7.1,30.8,4c9.3-2.6,19.3-9.7,23.9-18.4c4.9-9.3,7.4-20.5,4-30.8C895.5,921,889.5,910.7,880.2,906.5z"
        ...
        <div className="w-full flex justify-between gap-2 px-3">
          ...
          <p className="text-base font-medium w-full pl-3">Log Out</p>
        </div>
      </div>
    </>
  );
